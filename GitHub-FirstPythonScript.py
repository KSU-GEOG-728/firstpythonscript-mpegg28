...
flinthillsbuffer = arcpy.analysis.Buffer(flinthills, "FlintHills10km", "10 Kilometer", 'FULL', 'ROUND',  'NONE',"", 'PLANAR')

# Clip the Rivers inside the 10 km Buffer
ClippedRivers = arcpy.analysis.Clip('ks_major_rivers', flinthillsbuffer,"ClippedRivers")
